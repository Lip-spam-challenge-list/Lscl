        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <h3>Description</h3>
                    <p>
                        This is the Lip Spam Challenge List (LSCL) for the game Geometry Dash. This list ranks the top 100 hardest lip spam challenges in the game, focusing on levels by enabling extremely high clicks-per-second (CPS) to pass intense, high-speed, or bug-heavy segments where traditional clicking fails. It specifically helps in navigating spam-heavy wave or orb sections, particularly in impossible or challenging custom levels where consistent, fast inputs are required over a short, frantic period.
                    </p>
                    <p>
